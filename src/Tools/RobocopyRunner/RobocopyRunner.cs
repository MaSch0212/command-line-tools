    ...
    public class RobocopyRunner : BaseToolRunnerWithArgsParser
    {
        ...
        private ExitCode Handle(IRobocopyOptions options)
        {
            ...
            if (cmo != null)
            {
                ...
                //showProgress = cmo.ShowTotalProgress;
            }
            ...
            void OnNewOutput_Copy(string? data)
            {
                ...
                if (fileMatch.Success)
                {
                    ...
                    else
                    {
                        ...
                        {
                            p2!.StatusText = statusPrefix + "..." + fileName.Substring(fileName.Length - maxStatusTextLength + 2);
                        }
                        else
        ...
        private static void AddArg<T>(StringBuilder sb, string argName, T? value) where T : struct, IFormattable
        {
            if (value != null)
