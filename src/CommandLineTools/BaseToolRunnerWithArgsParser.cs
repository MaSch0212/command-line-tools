...
namespace MaSch.CommandLineTools
{
    public abstract class BaseToolRunnerWithArgsParser : IToolRunner
    {
        ...
        protected IConsoleService Console => _console;
        ...
        public BaseToolRunnerWithArgsParser()
        {
            ...
            ServiceContext.GetService(out _console);
            Configure(Options);
        }
        ...
        protected virtual ExitCode OnParsed(object options)
        {
            ...
            var func = getOptionHandler.MakeGenericMethod(options.GetType()).Invoke(Options, Array.Empty<object>())!;
