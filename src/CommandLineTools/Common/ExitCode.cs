...
namespace MaSch.CommandLineTools.Common
{
    ...
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1649:File name should match first type name", Justification = "The file name matches the first type (see Enum above).")]
